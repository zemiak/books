...
public class PrepareFileList implements Batchlet {
    ...
    public String process() throws Exception {
        ...
        LOG.log(Level.INFO, "Going to convert {0} books to EPUB.", counter);
    ...
    private void checkBookFile(String name) {
        ...
        if (ext.equals("pdb") || ext.equals("chm") || ext.equals("txt")
                || ext.equals("htm") || ext.equals("html") || ext.equals("rtf")) {
            files.add(name);
        }
    }
}
